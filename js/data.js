export default {
    ...
    about: {
        ...
        meme: {
            img: "./images/ME.PNG",
            content: "<span></span>我叫<b>刘若男</b>，今年21岁，是美国威斯康星麦迪逊大学的一名大四在读生，所学专业是<b>计算机科学</b>辅修<b>游戏设计</b>；<br /><span></span>我个人对于游戏设计开发有<b>浓厚的兴趣</b>，喜欢用学习到的知识去设计与开发一些游戏，喜欢通过游戏表达<b>自己的理念</b>。<br /><span></span>执行力、抗压力强；有<b>团队合作经验，沟通能力强</b>；适应力强，能很快融入集体；上进心强，愿意不断学习充实自己。"
        },
        ability: [{
                icon: "fa-gamepad",
                title: "游戏设计",
